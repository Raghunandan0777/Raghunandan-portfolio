...
export default function About() {
  ...
  return (
    <div className='about-section section' id="about">
      ...
      <a href="https://drive.google.com/file/d/1SYHNidWC2wnIWidrFSNEStjOVY3VT2bE/view?usp=drive_link" target='_blank'>
        <Button1>
          <SvgIcon icon={Pdf} />
          Resume
        </Button1>
